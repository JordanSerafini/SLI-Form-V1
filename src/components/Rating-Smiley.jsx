...
const RatingSmiley = () => {
  ...
  return (
    <ul
    className="flex list-none gap-2 p-0 w-full justify-center items-center pt-2"
    data-te-rating-init
    ...
    >
      ...
      <li>
        <span
          className="text-[#ff8000] [&>svg]:h-10 [&>svg]:w-10 [&>svg]:fill-current"
          data-te-rating-icon-ref
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      <li>
        <span
          className="text-[#03a9f4] [&>svg]:h-10 [&>svg]:w-10 [&>svg]:fill-current"
          data-te-rating-icon-ref
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      <li>
        <span
          className="text-[#90EE90] [&>svg]:h-10 [&>svg]:w-10 [&>svg]:fill-current"
          data-te-rating-icon-ref
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      <li>
        <span
          className="text-[#0e720eec] [&>svg]:h-10 [&>svg]:w-10 [&>svg]:fill-current"
          data-te-rating-icon-ref
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
